Feature: Assigning permissions
  ...
  Scenario: Setting permission to view a project by an user
  ...
  Scenario: Setting permission to create tickets for a project
    When I check "View" for "TextMate 2"
  ...
  Scenario: Updating a ticket for a project
    ...
    And I check "Update tickets" for "TextMate 2"
    And I press "Update"
    And I follow "Sign Out"
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
